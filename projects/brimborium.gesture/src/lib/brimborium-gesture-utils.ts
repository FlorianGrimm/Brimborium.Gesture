...
class FaultBrimboriumGestureManager implements IBrimboriumGestureManager {
    ...
    public calcGestureEnabled(interactionEnabled: Set<BrimboriumInteractionTypeName> | undefined): Set<BrimboriumGestureTypeName> | undefined { throw new Error("Not Allowed."); }
